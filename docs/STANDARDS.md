...
| **Package Manager**   | Use the package manager configured by each repository. <a href="https://www.npmjs.com/" target="_blank">npm</a> remains the default for repositories with `package-lock.json`.                                                                                                                                                                                            | <a href="https://pnpm.io/" target="_blank">pnpm</a> is being adopted progressively; migrated repositories should use `pnpm-lock.yaml` and the `packageManager` field. |
...
| **Icons**             | <a href="https://mui.com/material-ui/material-icons/" target="_blank">@mui/icons-material</a> and/or <a href="https://pictogrammers.com/library/mdi/" target="_blank">mdi-material-ui</a>, with fallback to custom <a href="https://mui.com/material-ui/icons/#svgicon" target="_blank">SvgIcon</a>                                                                       | None                                                                                                                                                                  |
| **Charts**            | <a href="https://mui.com/x/react-charts/" target="_blank">MUI X Charts</a> and <a href="https://recharts.org/" target="_blank">Recharts</a>. Choose the library that best fits the product context; prefer MUI X Charts for theme-native MUI experiences and Recharts when an existing product chart surface depends on it. DLS does not provide custom chart components. | None                                                                                                                                                                  |
...
DLS should stay focused on generic design-system primitives. Charting APIs tend
to become product- and data-shape-specific, so reusable chart wrappers should
live in application or product libraries when they are needed. Keep DLS chart
guidance to standards, theme compatibility, and reference examples rather than
exported custom chart components.
...
_This document is living and should be updated as standards evolve. All changes
should be discussed and approved by the front-end collective._
